...
ULONG_PTR findAddressByCode(ULONG_PTR beginAddr, ULONG_PTR endAddr, PFindCode  findCode, ULONG numbers);  //查询未导出函数地址封装
...
ULONG_PTR FindProcessName(PWCHAR ProcessName); //传入进程名，遍历PID来获取进程的Eprocess结构